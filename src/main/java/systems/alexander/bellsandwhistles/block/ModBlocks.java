...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> METRO_CASING = registerBlock("metro_casing",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.MOSSY_COBBLESTONE).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> METRO_WINDOW = registerBlock("metro_window",
            () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.MOSSY_COBBLESTONE).sound(SoundType.METAL).noOcclusion(), BlockSetType.STONE));
